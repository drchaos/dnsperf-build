...
, enableOpenssl ? false, enableSeccomp ? false
, libseccomp ? null, buildPackages
}:
...
stdenv.mkDerivation rec {
  ...
  configureFlags = [
    ...
    (if enableOpenssl then "--with-openssl=${openssl.dev}" else "--without-openssl")
